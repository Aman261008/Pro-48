...
function CreateAlien() {
  var aliens = createSprite(Math.round(random(20, 370)),0, 10, 10);
...
function CreateUfo() {
  var ufos = createSprite(Math.round(random(20, 370)),0, 10, 10);
...
function CreateComet() {
  var comets = createSprite(Math.round(random(0, windowWidth)),0, 10, 10);
